...
export default function AgentPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const response = await fetch(`${BASE_URL}/api/v1/agents/regex-builder/run`, {
        method: 'POST',
  ...
  return (
    <AgentPageLayout agent={agent}>
      <form onSubmit={handleSubmit} className='flex flex-col gap-5'>
        ...
        <div>
          <label htmlFor="input1" style={labelStyle}>Pattern Description</label>
          <textarea
            id="input1"
        ...
        <button
          type='submit'
          disabled={loading || !groqApiKey.trim() || !pattern.trim()}
